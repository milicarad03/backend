...
describe('DeviceService', () => {
  ...
  const mockDeviceRepository = {
    ...
    findAttributesBySerialNumber: jest.fn(),
  };
  ...
  it('should return the latest attributes to the device owner', async () => {
    ...
    mockDeviceRepository.findAttributesBySerialNumber.mockResolvedValue({
      serialNumber: 'SN-1',
      firmware: '1.1.3',
  ...
  it('should allow an administrator to read device attributes', async () => {
    mockDeviceRepository.findOne.mockResolvedValue({
      id: 'device-1',
      serialNumber: 'SN-1',
      userId: 2,
  ...
  it('should forbid another user from reading device attributes', async () => {
    mockDeviceRepository.findOne.mockResolvedValue({
      id: 'device-1',
      serialNumber: 'SN-1',
      userId: 2,
